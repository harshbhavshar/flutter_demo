  ...
  txt(String data,Color color,double fsize,FontWeight fweigth){
    return Flexible(
      child: Text(data,style: TextStyle(
        color: color,
        fontSize: fsize,
        fontWeight: fweigth, overflow: TextOverflow.fade
      ),
            ...
            FutureBuilder<Tracks?>(
              ...
              builder: (context, snapshot) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        Image.asset("assets/book.jpg",height: 220,),
                        SizedBox(height: 10,),
                        txt(data.artistName,Colors.white,20,FontWeight.bold),
                        SizedBox(height: 10,),
                        txt(data.albumName,Colors.white,20,FontWeight.bold),
                        SizedBox(height: 30,),
                        Flexible(
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: Column(
                                  children: [
                                   txt(data.trackName,Colors.white,20,FontWeight.bold),
                                    txt("TrackName",Colors.white60,15,FontWeight.bold),
                                  ],
                                ),
                              ),
                              Container(
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    txt(data.trackRating.toString(),Colors.white,20,FontWeight.bold),
                                    txt("Rating",Colors.white60,15,FontWeight.bold),
                                  ],
                                ),
                              )
                            ],
