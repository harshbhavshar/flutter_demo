...
Future<List<TrackList>>apihome() async {
  ...
  final response = await dio.get('https://api.musixmatch.com/ws/1.1/chart.tracks.get?apikey=2d782bc7a52a41ba2fc1ef05b9cf40d7');
...
Future<Tracks?> apisecond(int tid)async{
  ...
  final response = await dio.get('https://api.musixmatch.com/ws/1.1/track.get?track_id=$tid&apikey=2d782bc7a52a41ba2fc1ef05b9cf40d7');
...
Future<Lyrics?> apiThird(int tid)async{
  ...
  final response = await dio.get('https://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=$tid&apikey=2d782bc7a52a41ba2fc1ef05b9cf40d7');
  if(response.statusCode == 200){
    //print(response.data);
    final data = json.decode(response.data) as Map<String, dynamic>;;
