         ...
         if(snapshot.hasData){
           return GridView.builder(
               ...
               itemBuilder: (context, index){
                 ...
                 return InkWell(
                   onTap: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=>SecondScreen(id: data.trackId!,)));
                   },
                   child: Card(
                     child: Column(
                       children: [
                         SizedBox(height: 10,),
                         Image.asset('assets/book.jpg',height: 170,),
                         SizedBox(height: 10,),
                         Text(data.albumName!,style: TextStyle(
